...
<body>
    <div id="card" class="animated fadeIn">
        ...
        <div id="lower-side">
            <p id="message">
                Congratulations, your data has been successfully created into American College.
            </p>
            <a href="/home" id="contBtn">login</a>
        </div>
    </div>
</body>
</html><?php /**PATH C:\sample-laravel-prj\resources\views/frontend/regsucess.blade.php ENDPATH**/ ?>